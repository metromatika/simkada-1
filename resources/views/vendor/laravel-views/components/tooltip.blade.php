...
{{-- <div x-data="{ tooltip: false }" class="cursor-pointer relative inline-flex" --}}
 {{-- @mousemove.away="tooltip = false" --}}
 {{-- > --}}
  {{-- <span --}}
  {{-- @mousemove="tooltip = true" @mouseleave="tooltip = false" --}}
  {{-- > --}}
    {{ $slot }}
  {{-- </span> --}}

  {{-- <div class="relative" x-cloak data-bs-toggle="tooltip"> --}}
