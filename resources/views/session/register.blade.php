      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            ...
            <p class="text-lead text-white">Silakan daftarkan akun anda di, SIMKADA</p>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
          <div class="card z-index-0">
            <div class="card-header text-left pt-4">
              <h5 class="text-center">Pilih Posisi</h5>
              <form class="form text-left" method="POST" action="/register">
                @csrf
              <div class="mb-2">
            ...
            <div class="card-body p-0">
                ...
                <div class="form-check form-check-info text-left">
                  ...
                  <label class="form-check-label" for="flexCheckDefault">
                    Saya Setuju <a href="javascript:;" class="text-dark font-weight-bolder">Syarat dan Ketetuan</a>
                  </label>
                  @error('agreement')
