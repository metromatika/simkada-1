                ...
                <div class="card-header pb-0">
                    <div class="d-flex flex-row">
                        ...
                        <div class="d-flex align-items-center justify-content-center">
                            <x-button_create id_modal="formDataTPS" button_create="TPS"></x-button_create>
                        </div>
                            ...
                            <div class="dataTable-container">
                                <table class="table table-flush dataTable-table align-items-center mb-0" id="dataTPS">
                                    <thead class="thead-light">
                                        <tr>
                                            <th
                                                class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 asc">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="{{ route('edit-TPS', ['id' => $item->id]) }}" class="mx-3"
                                                        id="edit-btn" data-bs-toggle="modal" data-bs-target="#formDataTPS">
