<div class="modal fade" id="formDataSaksi" tabindex="-1" role="dialog" aria-labelledby="modalTitleId" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form text-left" method="POST" action="{{ route('create-saksi') }}">
                    @csrf
                    ...
                    <div class="mb-2">
                        <select class="form-control" name="role" id="role">
                            ...
                            <option disabled value="Anggota">Anggota</option>
                    ...
                    <x-input class="" value="" for_name_id="ref_referal" content="Referensi Referal" type="text" placeholder="Referensi Referal Anda (6 huruf)..." />

                    <div class="mt-2 position-relative text-center">
                        <p class="text-sm font-weight-bold mb-2 text-dark text-border d-inline z-index-2 bg-white px-3">Kredensial</p>
                    </div>
                    ...
                    <div class="mt-2 position-relative text-center">
                        <p class="text-sm font-weight-bold mb-2 text-dark text-border d-inline z-index-2 bg-white px-3">Data Diri</p>
                    </div>
                    ...
                    <div class="mt-2 position-relative text-center">
                        <p class="text-sm font-weight-bold mb-2 text-dark text-border d-inline z-index-2 bg-white px-3">Data Alamat Lengkap</p>
                    </div>
                    ...
                    <div class="input-group mt-2">
                        ...
                        <input type="text" name="rt" id="rt" aria-label="RT" class="form-control" placeholder="(000)">
                        <span class="input-group-text">RW</span>
                        <input type="text" name="rw" id="rw" aria-label="RW" class="form-control" placeholder="(000)">
                        <span class="input-group-text">TPS</span>
                        <input type="text" name="tps" id="tps" aria-label="TPS" class="form-control" placeholder="(000)">
                    </div>
