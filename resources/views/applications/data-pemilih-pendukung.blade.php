                    ...
                    <table class="table align-items-center mb-0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-center">
                                    <p class="text-xs font-weight-bold mb-0">Zacky</p>
                                </td>
                                <td class="text-center">
                                    <p class="text-xs font-weight-bold mb-0">20 Agustus 2022</p>
                                </td>
                                <td class="text-center">
                                    <p class="text-xs font-weight-bold mb-0">Banten</p>
                                </td>
                                <td class="text-center">
                                    <p class="text-xs font-weight-bold mb-0">20 Agustus 2000</p>
                                </td>
                                <td class="text-center">
                                ...
                                <td class="text-center">
                                    <p class="text-xs font-weight-bold mb-0">Tionghoa</p>
                                </td>
                                <td class="text-center">
